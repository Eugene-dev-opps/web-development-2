...
<div class="main">
    <div class="container">
        <h2><?php echo $packages["name"]; ?> Donation <font color="#000000">(&#8358;<?php echo $packages["amt_pay"]; ?>)</font></h2>
...
$checkUserPriv = mysqli_query($conn, 'select * from donations where donor_id="'.$dnnUsers['id'].'" order by date desc limit 1');
$checkUserPriv2 = mysqli_fetch_array($checkUserPriv);

if($checkUserPriv["status"]=="completed" or $checkUserPriv["status"]=="") {
...
?>
<div class="alert alert-danger" role="alert">
    <strong>Failed!</strong> You cannot make a new donation until you have completed the previous donation. Kindly complete your last donation or contact support. <?php echo $checkUserPriv2["status"]; ?>
</div>
<?php
}//status check
?>
...
?>
        ...
        <div class="row" style="padding-top:20px;">
            <form class="form" action="makeDonation.php?q=<?php echo $q; ?>" name="add" id="add" method="post">
                <div class="col-md-6">
